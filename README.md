...
WiSSkHy is a **local** and **flexible** framework built with R-Shiny and SQLite for hydrological data management based on an SQLite database and fully open-source tools. Its database architecture follows the [OGC SensorThings API standard](https://docs.ogc.org/is/18-088/18-088.html) (ISO 19156-based).
